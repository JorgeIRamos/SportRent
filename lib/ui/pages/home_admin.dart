        ...
        child: Column(
          ...
          children: [
            ...
            if (pendientesVerif.isNotEmpty) ...[
              ...
              const SizedBox(height: 10),
              ...pendientesVerif.map((e) => _EmpresaPendienteCard(
                    empresa: e,
            ...
            const SizedBox(height: 10),
            ...canchas.take(2).map((c) => _CanchaAdminRow(
                  cancha: c,
        ...
        Expanded(
          child: Obx(() {
            ...
            return ListView.builder(
              ...
              itemBuilder: (_, i) => _CanchaAdminRow(
                cancha: canchas[i],
      ...
      return ListView(
        ...
        children: [
          ...
          if (pendientes.isNotEmpty) ...[
            ...
            ...pendientes.map((e) => _EmpresaPendienteCard(
                  empresa: e,
                  onAprobar: () => _empresaCtrl.verificarEmpresa(e.id),
                  onRechazar: () => _empresaCtrl.rechazarEmpresa(e.id),
                )),
          ...
          ...empresas.map((e) => _EmpresaRow(empresa: e)),
        ],
      );
    });
  }
...
class _EmpresaRow extends StatelessWidget {
  ...
  const _EmpresaRow({required this.empresa});

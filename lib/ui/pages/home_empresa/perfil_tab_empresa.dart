        ...
        child: Column(
          children: [
            ...
            SeccionPerfilEmpresa(titulo: 'Información de la empresa', items: [
              InfoItemEmpresa(icono: Icons.business_outlined, label: 'Empresa', valor: nombreEmpresa.isNotEmpty ? nombreEmpresa : '—'),
              InfoItemEmpresa(icono: Icons.badge_outlined, label: 'NIT', valor: nit.isNotEmpty ? nit : '—'),
              InfoItemEmpresa(icono: Icons.person_outline, label: 'Responsable', valor: nombre.isNotEmpty ? nombre : '—'),
              InfoItemEmpresa(icono: Icons.phone_outlined, label: 'Teléfono', valor: telefono.isNotEmpty ? telefono : '—'),
              InfoItemEmpresa(icono: Icons.email_outlined, label: 'Correo', valor: email.isNotEmpty ? email : '—'),
            ]),
